...
function gymLabel(teamName, teamId, gymPoints, latitude, longitude) {
  var lastScanned = arguments.length <= 5 || arguments[5] === undefined ? null : arguments[5];
  var name = arguments.length <= 6 || arguments[6] === undefined ? null : arguments[6];
...
function processPokemons(i, item) {
  ...
  if ((!(encounterId in mapData.pokemons) || mapData.pokemons[encounterId]['iv_attack'] !== item['iv_attack']) && excludedPokemon.indexOf(item['pokemon_id']) < 0) {
